...
//       if (room === deletedRoom) {
//         alert(`Room "${deletedRoom}" was deleted.`);
//         handleExitRoom();
//       }
//     });
...
//     const passwordInput = prompt(`Enter password to delete room "${roomName}":`);
//     if (!passwordInput) return;

//     socket.emit('delete_room', { room: roomName, password: passwordInput }, (response) => {
//       if (response.success) {
//         setRoomList((prev) => prev.filter((r) => r !== roomName));
//         if (room === roomName) handleExitRoom();
//         setError('');
//       } else {
...
//                 <button onClick={() => deleteRoom(roomName)}>✕</button>
//               </li>
//             ))}
//           </ul>
//         </nav>
